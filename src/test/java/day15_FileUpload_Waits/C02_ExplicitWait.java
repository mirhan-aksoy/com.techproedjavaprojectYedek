...
//       assertTrue( driver.findElement(By.xpath("//div[@id='finish']//h4")).isDisplayed()); //Burada implcit wait kullanıldı
        ...
        //Implicit wait ile test geçmedi. sayfa yüklendi ama başka sebepten yüklenmeyenler ver.
        // Explicit wait kullanacağız:
        // özel durumdan dolayı ımplicit ile cözülmedi , farklı bir bekleme sbebi olmuş
