...
public class C02_WindowHandle extends TestBase {
    ...
    public void windowHandle() {
        ...
        String techproWindowHandle = driver.getWindowHandle();//Techpro sayfasının
        // handle değerini bir String'e assing ettik
        ...
        String youtubeWindowHandle = driver.getWindowHandle();//Youtube sayfasının
        // handle değerini bir String'e assing ettik
